...
import FormWrapper,
       { MedicalHistoryQuestionnaire } from './MedicalHistoryQuestionnaire'
...
const component = shallow(
  <MedicalHistoryQuestionnaire {...props} />
)

//-----------  Component Tests  -----------//

describe('<MedicalHistoryQuestionnaire />', () => {
...
describe('MedicalHistoryQuestionnaire: Fields', () => {
...
describe('MedicalHistoryQuestionnaire: Calculations', () => {
