...
import FormWrapper,
       { DiagnosisDatesQuestionnaire } from './DiagnosisDatesQuestionnaire'
...
const component = shallow(
  <DiagnosisDatesQuestionnaire {...props} />
)

//-----------  Component Tests  -----------//

describe('<DiagnosisDatesQuestionnaire />', () => {
...
describe('DiagnosisDatesQuestionnaire: Fields', () => {
...
describe('DiagnosisDatesQuestionnaire: Calculations', () => {
